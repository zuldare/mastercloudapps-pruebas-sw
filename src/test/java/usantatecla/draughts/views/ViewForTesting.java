...
class ViewForTesting implements InteractorControllersVisitor {
    ...
    void writePiecesRow(final int row, InteractorController controller) {
  ...
  /* ************** */
    ...
    void interactPlay(PlayController playController) {
        assert playController != null;
        Error error;
        do {
            error = Error.NONE;
